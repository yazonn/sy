...
if (message.author.id !== '437996733654368257','437996733654368257') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
/*
client.on('message', message=>{
    if (message.content ===  "مع السلامه نشوفك بعدين انشاءالله"){
    message.guild.leave();
            }
});
*/
